...
function createTotalHtml(result){
    // alert(result.left_daily_lottery_count)
    ...
    var clickfunc = function(result) {
        ...
        switch (data) {
            case 1:
                // rotateFunc(1, 7, '1');
                rotateFunc(1, 5, "<p class='texts'><img src='img/award/img1.png'></p><p class='ok-img'>知道了</p>");
                break;
            case 2:
                rotateFunc(2, 50, "<p class='texts'><img src='img/award/img05.png'></p><p class='ok-img'>知道了</p>");
                // rotateFunc(2, 54, 'img/award/img05.svg');
                // rotateFunc(2, 54, '0.5');
                break;
            case 3:
                rotateFunc(3, 95, "<p class='texts'><img src='img/award/img-more.png'></p><p class='ok-img'>知道了</p>");
                // rotateFunc(3, 98, '再接再厉');
                break;
            case 4:
                rotateFunc(4, 140, "<p class='texts'><img src='img/award/img08.png'></p><p class='ok-img'>知道了</p>");
                // rotateFunc(4, 145, '0.8');
                break;
            case 5:
                rotateFunc(5, 185, "<p class='texts'><img src='img/award/img01.png'></p><p class='ok-img'>知道了</p>");
                // rotateFunc(5, 190, '0.1');
                break;
            case 6:
                rotateFunc(6, 230, "<p class='texts'><img src='img/award/img-more.png'></p><p class='ok-img'>知道了</p>");
                // rotateFunc(6, 235, '再接再厉');
                break;
            case 7:
                rotateFunc(7, 275, "<p class='texts'><img src='img/award/img005.png'></p><p class='ok-img'>知道了</p>");
                // rotateFunc(7, 280, '0.05');
                break;
            case 8:
                rotateFunc(8, 320, "<p class='texts'><img src='img/award/img001.png'></p><p class='ok-img'>知道了</p>");
