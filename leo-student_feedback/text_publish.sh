...
#ssh -p56000 ybai@$ip "mkdir /var/www/wx-parent-web.leo1v1.com/wx_yxyx_student_feedback"
echo "unpack  www"
ssh -p56000 ybai@$ip "tar xvf wx_yxyx_student_feedback.tar.gz  -C /var/www/wx-parent-web.leo1v1.com/wx_yxyx_student_feedback"
