...
$(function(){
    $.ajax({
        "url": "//wx-parent.leo1v1.com/wx_parent_api/check_is_admin",
        "type": 'get',
        "dataType": 'jsonp',
        "data": {
            //            'page_num':page_num
        ...
        success: function(result) {
            if (result['ret'] != 0) {
                alert(result['info']);
                window.location.href="http://wx-parent-web.leo1v1.com/wx_yxyx_BoutiqueContent/leoInter.html";
            } else {
                // 成功
//                    alert("test");
        ...
        Ajax();
        // var timeStr="2017-08-15 17:01:58";
        // var tt=parseDate(timeStr);
});
function knowledgeFunc(number){
    if(number==0){
        $.ajax({
            "url": "//wx-parent.leo1v1.com/wx_parent_api/check_is_admin",
            "type": 'get',
            ...
            success: function(result) {
                if (result['ret'] != 0) {
                    ...
                    // 成功
//                    alert("test");
                    window.location.href="http://wx-parent-web.leo1v1.com/wx_yxyx_BoutiqueContent/index.html?p_phone="+result.phone;
                }
            }
        });
//    		window.location.href="http://wx-parent-web.leo1v1.com/wx_yxyx_BoutiqueContent/index.html?p_phone="+geturl("p_phone");
    }else if(number==1){
        $.ajax({
            "url": "//wx-parent.leo1v1.com/wx_parent_api/check_is_admin",
            "type": 'get',
...
//         window.location.href= 'detail.html?id='+id+'&flag='+flag+'&wx_openid='+geturl('wx_openid')+'&p_phone='+geturl("p_phone");
        window.location.href= '//wx-parent-web.leo1v1.com/wx_yxyx_student_feedback/detail.html?id='+id+'&flag='+flag+'&wx_openid='+geturl('wx_openid')+'&p_phone='+geturl("p_phone");
    }
}
function detailFuncs(id,index){
    if(index==1){
//         window.location.href= 'detail.html?id='+id+'&wx_openid='+geturl('wx_openid')+'&p_phone='+geturl("p_phone");
        window.location.href= '//wx-parent-web.leo1v1.com/wx_yxyx_student_feedback/detail.html?id='+id+'&wx_openid='+geturl('wx_openid')+'&p_phone='+geturl("p_phone");
    }
}
